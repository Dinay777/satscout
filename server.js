...
- Составляешь планы — двухуровневая структура:
  1. Узнай: параллельно обе секции или по очереди? Сколько времени в день?
  2. Дай высокоуровневый план: цель (балл + дата) + weekly overview
  3. Спроси: "Нужен детальный план на каждый день?"
  4. Только если просят — давай детальный: ресурс → раздел → задачи/минуты → порядок
  5. В конце любого плана — спроси что не нравится, предложи альтернативы
