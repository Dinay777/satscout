    ...
    values: [
      {
        ...
        description: '29 excellent resources beat 200 mediocre ones every time. Every resource in our library was chosen because it genuinely works.',
      },
      {
        iconKey: 'globe',
    ...
    values: [
      {
        ...
        description: '29 отличных ресурсов всегда лучше 200 посредственных. Каждый ресурс в библиотеке выбран потому, что он реально работает.',
      },
      {
        iconKey: 'globe',
