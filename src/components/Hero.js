...
const text = {
  en: {
    ...
    title2: 'More scoring.',
    subtitle: "The best free SAT resources, plus an AI tutor that builds your study plan and helps when you're stuck. No $200 courses to buy first.",
  ...
  ru: {
    ...
    subtitle: 'Лучшие бесплатные ресурсы для SAT и AI-репетитор, который составит план и подскажет, когда застрял. Без курсов за 200$ на старте.',
    cta1: 'Ресурсы',
    cta2: 'AI Помощник',
    stat1num: '34',
