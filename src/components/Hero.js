...
const text = {
  en: {
    ...
    title2: 'More scoring.',
    subtitle: 'Curated resources, AI-powered study help, and personalized prep plans — all in one place. No $200 courses. No fluff. Just what works.',
    ...
    floatScore: '+350 pts',
    floatScoreLabel: 'score increase',
    floatRating: '⭐ 4.9',
  ...
  ru: {
    ...
    title1: 'Less guessing.',
    title2: 'More scoring.',
    subtitle: 'Проверенные ресурсы, AI-помощник и персональные планы подготовки — всё в одном месте. Без курсов за 200$. Без воды. Только то, что работает.',
    cta1: 'Ресурсы',
    cta2: 'AI Помощник',
    stat1num: '50+',
