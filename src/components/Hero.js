...
const text = {
  en: {
    ...
    title2: 'More scoring.',
    subtitle: "The best free SAT prep already exists — I just organized it and added an AI tutor that builds your plan and helps when you're stuck. No $200 course required.",
    ...
    floatScore: '100%',
    floatScoreLabel: 'Free, always',
    floatRating: '⭐ 4.9',
    floatRatingLabel: 'Khan Academy',
  },
  ru: {
    badge: 'Бесплатная подготовка к SAT',
    title1: 'Меньше догадок.',
    title2: 'Больше баллов.',
    subtitle: 'Лучшие бесплатные материалы для SAT уже существуют — я просто собрала их вместе и добавила AI-репетитора, который строит план и помогает, когда застрял. Без курса за 200$.',
    cta1: 'Ресурсы',
    cta2: 'AI Помощник',
    stat1num: '29',
    ...
    floatScore: '100%',
    floatScoreLabel: 'Всегда бесплатно',
    floatRating: '⭐ 4.9',
    floatRatingLabel: 'Khan Academy',
  }
};
